...
🤖 Robotics developer  
🔧 Working with: Arduino, Raspberry Pi, Computer Vision, AI  
🚀 Building robots for competitions  


## 🧠 About me
I develop autonomous robots for competitions.  
My interests include:
- computer vision  
- robot control systems  
- neural networks on Raspberry Pi  
- embedded systems  
...
- 🧭 Maze Solver Robot — maze navigation robot  
- 🏎 Line Follower Pro — advanced line-following robot  
